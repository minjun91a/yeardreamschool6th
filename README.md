...
| 🖥 브라우저 (Client) | ⇄ | ⚙️ FastAPI 서버 (Stateless) | ⇄ | 🤖 AI API |
|:---|:---:|:---|:---:|:---|
| · UI<br>· **Pyodide**로 코드 실행·채점<br>· 키·진행상황 `localStorage` | **HTTPS** | · 변환·요약·도우미·챗봇 중계<br>· **키 미저장** (BYOK)<br>· 사용자 코드 실행 안 함 | **BYOK** | · Gemini · Claude<br>· 사용자 키로 호출 |
